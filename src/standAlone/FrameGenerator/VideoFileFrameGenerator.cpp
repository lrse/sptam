...
VideoFileFrameGenerator::VideoFileFrameGenerator(const std::string& fileName)
  : videoCapture_()
{
  videoCapture_.open( fileName );

  if (not videoCapture_.isOpened())
    throw std::invalid_argument("Unable to read vide: " + fileName);
}
